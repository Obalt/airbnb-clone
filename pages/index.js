...
export default function Home({exploreData, cardsData}) {
  return (
    <div className=''>
      <Head>
        <title>AirBnb by Sithembiso</title>
...
export async function getStaticProps(){
  const exploreData = await fetch("https://jsonkeeper.com/b/ED0U").then((res) =>
    res.json()
  );

  const cardsData = await fetch("https://jsonkeeper.com/b/QR2Z").then((res) =>
    res.json()
  );
